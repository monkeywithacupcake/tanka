#!/usr/bin/env python3
"""
Tanka HaikuBox Bird Data Downloader - Main Entry Point

Usage:
    python main.py                         # Download yesterday's data for all enabled HaikuBoxes
    python main.py --date 2024-01-15       # Download data for specific date
    python main.py --box my-name-brbs      # Download for specific HaikuBox only
    python main.py --headless false        # Run browser in visible mode (for debugging)
"""
...
def main():
    ...
    logger.info("=" * 60)
    logger.info("Tanka HaikuBox Bird Data Downloader - Starting")
    logger.info("=" * 60)
